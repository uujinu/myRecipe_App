...
export default function AvatarElement(props) {
  ...
  const handleLogout = () => {
    axios.get("http://localhost:8000/accounts/logout/", {headers: {"Content-type": "application/json"}, withCredentials: true})
    .then(res => {
  ...
  return (
    <div>
      <AvatarBtn aria-controls="simple-menu" aria-haspopup="true" onClick={handleOnClick} disableTouchRipple={true}>
